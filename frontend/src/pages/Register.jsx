...
import { Car, Lock, Mail, User, Shield, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full glass-panel p-8 rounded-3xl border border-slate-800 space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-slate-400">Join DrivePulse inventory portal</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <Shield className="absolute left-3.5 top-3 w-5 h-5 text-slate-400" />
              <select
                {...register('role')}
                className="w-full pl-11 pr-4 py-2.5 bg-slate-900 border border-slate-700 rounded-xl text-sm text-white focus:border-cyan-500"
              >
